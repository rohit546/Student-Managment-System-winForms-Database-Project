...
namespace DB_Project {
    ...
    public partial class DataSet5 : global::System.Data.DataSet {
        ...
        public partial class CLASSDataTable : global::System.Data.TypedTableBase<CLASSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CLASSRow AddCLASSRow(int CLASS_ID) {
        ...
        public partial class STUDENTDataTable : global::System.Data.TypedTableBase<STUDENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public STUDENTRow AddSTUDENTRow(int SID, string FIRST_NAME, string LAST_NAME, string CONTACT_NO, string ADDRESS) {
...
namespace DB_Project.DataSet5TableAdapters {
    ...
    public partial class CLASSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM \"ROHIT1\".\"CLASS\" WHERE ((\"CLASS_ID\" = :Original_CLASS_ID))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE \"ROHIT1\".\"CLASS\" SET \"CLASS_ID\" = :CLASS_ID WHERE ((\"CLASS_ID\" = :Original" +
                "_CLASS_ID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CLASS_ID FROM ROHIT1.CLASS";
        ...
        public virtual int Fill(DataSet5.CLASSDataTable dataTable) {
        ...
        public virtual DataSet5.CLASSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet5.CLASSDataTable dataTable = new DataSet5.CLASSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet5.CLASSDataTable dataTable) {
        ...
        public virtual int Update(int CLASS_ID, int Original_CLASS_ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Original_CLASS_ID) {
    ...
    public partial class STUDENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""ROHIT1"".""STUDENT"" WHERE ((""SID"" = :Original_SID) AND (""FIRST_NAME"" = :Original_FIRST_NAME) AND (""LAST_NAME"" = :Original_LAST_NAME) AND ((:IsNull_CONTACT_NO = 1 AND ""CONTACT_NO"" IS NULL) OR (""CONTACT_NO"" = :Original_CONTACT_NO)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::Oracle.ManagedDataAccess.Client.OracleParameter param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            ...
            this._adapter.UpdateCommand = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""ROHIT1"".""STUDENT"" SET ""SID"" = :SID, ""FIRST_NAME"" = :FIRST_NAME, ""LAST_NAME"" = :LAST_NAME, ""CONTACT_NO"" = :CONTACT_NO, ""ADDRESS"" = :ADDRESS WHERE ((""SID"" = :Original_SID) AND (""FIRST_NAME"" = :Original_FIRST_NAME) AND (""LAST_NAME"" = :Original_LAST_NAME) AND ((:IsNull_CONTACT_NO = 1 AND ""CONTACT_NO"" IS NULL) OR (""CONTACT_NO"" = :Original_CONTACT_NO)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::Oracle.ManagedDataAccess.Client.OracleCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT SID, FIRST_NAME, LAST_NAME, CONTACT_NO, ADDRESS FROM ROHIT1.STUDENT";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet5.STUDENTDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet5.STUDENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet5.STUDENTDataTable dataTable = new DataSet5.STUDENTDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet5.STUDENTDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_SID, string Original_FIRST_NAME, string Original_LAST_NAME, string Original_CONTACT_NO, string Original_ADDRESS) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int SID, string FIRST_NAME, string LAST_NAME, string CONTACT_NO, string ADDRESS, int Original_SID, string Original_FIRST_NAME, string Original_LAST_NAME, string Original_CONTACT_NO, string Original_ADDRESS) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIRST_NAME, string LAST_NAME, string CONTACT_NO, string ADDRESS, int Original_SID, string Original_FIRST_NAME, string Original_LAST_NAME, string Original_CONTACT_NO, string Original_ADDRESS) {
            return this.Update(Original_SID, FIRST_NAME, LAST_NAME, CONTACT_NO, ADDRESS, Original_SID, Original_FIRST_NAME, Original_LAST_NAME, Original_CONTACT_NO, Original_ADDRESS);
        }
    }
